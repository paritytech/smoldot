...
extern "C" {
    ...
    /// that the request was made to. `source_id` is the value that was passed to [`json_rpc_send`].
    pub fn json_rpc_respond(ptr: u32, len: u32, chain_index: u32, source_id: u32);
