...
cargo build --package substrate-lite-js --target wasm32-unknown-unknown --no-default-features --release &&
    wasm-opt -o autogen/tmp.wasm -O ../../../target/wasm32-unknown-unknown/release/substrate_lite_js.wasm &&
