...
if (fallbackCopy) {
    fs.copyFileSync("../../../target/wasm32-wasi/" + buildProfile + "/smoldot_light_wasm.wasm", "./src/worker/autogen/tmp.wasm");
}
...
// small size files.
const wasmOptOut = fs.readFileSync('./src/worker/autogen/tmp.wasm');
