...
- Fix panic when a relay chain block is pruned at the same time as we are trying to determine the parachain block corresponding to it. ([#2414](https://github.com/paritytech/smoldot/pull/2414))
