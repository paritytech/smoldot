...
- Standalone/relay chains that use neither Aura nor Babe are no longer supported. Parachains that don't use Aura/Babe continue to work. ([#2481](https://github.com/paritytech/smoldot/pull/2481))
