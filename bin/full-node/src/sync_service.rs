...
pub struct Config {
    ...
    /// Database where to store events.
    #[cfg(feature = "events-export")]
    pub major_sync_export_events_sqlite: Option<sqlite::Connection>,
}
    ...
    pub async fn new(mut config: Config) -> Arc<Self> {
        ...
        (config.tasks_executor)(Box::pin(
            start_database_write(
                ...
                messages_rx,
                #[cfg(feature = "events-export")]
                config.major_sync_export_events_sqlite.map(SqliteSendHack),
            )
            .instrument(
...
// TODO: fix in upstream library
#[cfg(feature = "events-export")]
struct SqliteSendHack(sqlite::Connection);
#[cfg(feature = "events-export")]
unsafe impl Send for SqliteSendHack {}
#[cfg(feature = "events-export")]
unsafe impl Sync for SqliteSendHack {}
#[cfg(feature = "events-export")]
impl core::ops::Deref for SqliteSendHack {
...
#[cfg(feature = "events-export")]
impl core::ops::DerefMut for SqliteSendHack {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
#[cfg(feature = "events-export")]
struct SqliteStmtSendHack<'a>(sqlite::Statement<'a>);
#[cfg(feature = "events-export")]
unsafe impl<'a> Send for SqliteStmtSendHack<'a> {}
#[cfg(feature = "events-export")]
unsafe impl<'a> Sync for SqliteStmtSendHack<'a> {}
#[cfg(feature = "events-export")]
impl<'a> core::ops::Deref for SqliteStmtSendHack<'a> {
    type Target = sqlite::Statement<'a>;
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[cfg(feature = "events-export")]
impl<'a> core::ops::DerefMut for SqliteStmtSendHack<'a> {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}
...
#[tracing::instrument(skip(database, messages_rx, major_sync_export_events_sqlite))]
async fn start_database_write(
    database: Arc<full_sled::SledFullDatabase>,
    mut messages_rx: mpsc::Receiver<ToDatabase>,
    #[cfg(feature = "events-export")] major_sync_export_events_sqlite: Option<SqliteSendHack>,
) {
