...
//! manging the collection manually (e.g. with a `Vec`) are:
//!
//! - Providing an API that is fundamentally compatible with back-pressure mechanisms.
//! - Making it possible to add support for the QUIC protocol later. When using QUIC, one receives
//! UDP packets without being able to know which connection they are destined to before inspecting
//! them.
//!
