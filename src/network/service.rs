...
impl<TNow, TPeer, TConn, TPending, TSub, TPendingSub, TRq> Network<TNow, TPeer, TConn, TPending, TSub, TPendingSub, TRq> {
...
impl<TNow, TPeer, TConn, TPending, TSub, TPendingSub, TRq> Connection<TNow, TPeer, TConn, TPending, TSub, TPendingSub, TRq> {
