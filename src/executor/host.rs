...
impl HostVmPrototype {
    ...
    pub fn run_vectored(
        ...
        let mut vm = match self.vm_proto.start(
            vm::HeapPages::new((data_len_u32 + self.heap_base) / (64 * 1024)), // TODO: `data_len_u32 + ` is a hack for the start value; solve with https://github.com/paritytech/smoldot/issues/132
            function_to_call,
            &[
